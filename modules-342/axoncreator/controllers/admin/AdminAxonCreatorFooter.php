...
class AdminAxonCreatorFooterController extends ModuleAdminController
{
            ...
            'general' => array(
                ...
                'fields' =>    array(
                    'active_footer_layout' => array(
                        'title' => $this->module->l('Footer layout'),
                        'desc' => $this->module->l('Choose your footer layout. You can create multiple layouts in list above. So you can change them fast when needed.'),
                        'cast' => 'intval',
                        'type' => 'select',
    ...
    {
        $this->toolbar_title[] = $this->module->l('Axon - Footer');
    }
