...
class AdminAxonCreatorHomeController extends ModuleAdminController
{
            ...
            'general' => array(
                ...
                'fields' =>    array(
                    'active_home_layout' => array(
                        'title' => $this->module->l('Home layout'),
                        'desc' => $this->module->l('Choose your home layout. You can create multiple layouts in list above. So you can change them fast when needed.'),
                        'cast' => 'intval',
                        'type' => 'select',
    ...
    {
        $this->toolbar_title[] = $this->module->l('Axon - Home');
    }
