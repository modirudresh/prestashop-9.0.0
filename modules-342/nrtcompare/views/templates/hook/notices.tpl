{if isset($product)}
	...
	<div class="ax-n-wrapper">
		...
		<span class="ax-n-info">
			{l s='Product successfully added to your compare' mod='nrtcompare'}
		</span>
		<div class='group_button'>
			<a href='{url entity='module' name='nrtcompare' controller='comparator'}' title='{l s="Go to Compare" mod="nrtcompare"}'>
				{l s='Go to Compare' mod='nrtcompare'}
			</a>
		</div>
	</div>
{else}
	<div class="ax-n-wrapper">
		<span class="ax-n-error">
			{l s='Product not found.' mod='nrtcompare'}
		</span>
		<a href='{url entity='module' name='nrtcompare' controller='comparator'}' class='goto_page' title='{l s="Go to Compare" mod="nrtcompare"}'>
			{l s='Go to Compare' mod='nrtcompare'}
		</a>
	</div>
{/if}