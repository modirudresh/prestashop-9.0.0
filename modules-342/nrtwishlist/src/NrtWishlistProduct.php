...
class NrtWishlistProduct extends ObjectModel
{
    ...
    {		
		...
		$sql = 'SELECT id_nrt_wishlist_product FROM `' . _DB_PREFIX_ . 'nrt_wishlist_product` WHERE `id_customer` = ' . (int)$idCustomer . ' AND `id_product` = ' . (int)$idProduct . ' AND `id_shop` = ' . (int)$idShop;
		//getValue   getRow    
