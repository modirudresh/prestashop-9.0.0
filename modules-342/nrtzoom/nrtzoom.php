...
class NrtZoom extends Module implements WidgetInterface 
{
    ...
    public function __construct()
    {
        ...
        $this->templateFile = 'module:nrtzoom/views/templates/hook/nrtzoom.tpl';
    ...
    public function hookDisplayHeader()
    {
		if(Configuration::get('NRT_zoom_enable')){
			$this->context->controller->registerJavascript('js_easyzoom', 'modules/'.$this->name.'/views/js/easy-zoom.min.js', ['position' => 'bottom', 'priority' => 150]);
			$this->context->controller->registerJavascript('js_zoom', 'modules/'.$this->name.'/views/js/zoom.min.js', ['position' => 'bottom', 'priority' => 150]);	
			$this->context->controller->addCSS($this->_path.'views/css/easy-zoom.css');
		}			
    }
