...
class BlogImageType extends ObjectModel
{
    ...
    public static function ImageGenerate()
    {
        ...
        foreach ($author_types as $author_type) {
            ImageManager::resize($get_author_image, _PS_MODULE_DIR_ . 'smartblog/images/avatar/avatar_' . stripslashes($author_type['type_name']) . '.jpg', (int) $author_type['width'], (int) $author_type['height']
            );
        }
    }
