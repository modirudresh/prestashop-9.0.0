...
{ 
    public function __construct()
    {
        ...
        $this->tpl_list_vars['title'] = $this->module->l('Categories');
    ...
    public static function getCurrentBlogCategory()
    {
        ...
        $category = new BlogCategory($id_smart_blog_category);
    ...
    public function renderPageHeaderToolbar()
    {
        ...
        if (Tools::getValue('add'.$this->table) !== false) {
            $this->toolbar_title[] = $this->module->l('New Category');
        } elseif(Tools::getValue('update'.$this->table) !== false) {
            $this->toolbar_title[] = $this->module->l('Update Category');
        } else {
            $this->toolbar_title[] = $this->module->l('Category');

            $this->page_header_toolbar_btn['new_smart_cmsblog_category'] = array(
                'href' => self::$currentIndex.'&add'.$this->table.'&token='.$this->token,
                'desc' => $this->module->l('Add new category', null, null, false),
       ...
       // $root = BlogCategory::getRootCategory()['id_smart_blog_category'];
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'html',
                    'label' => $this->module->l('Parent Blog Category'),
                    'name' => 'id_parent',
                    'col' => '4',
                ...
                array(
                    'type' => 'file',
                    'label' => $this->module->l('Category Image:'),
                    'name' => 'category_image',
                    'display_image' => true,
                    ...
                    'hint' => $this->module->l('Upload a feature image from your computer.(.jpg)'),
					'desc' => $this->module->l('Upload a feature image from your computer.(.jpg)')
                ),
                array(
                    'type' => 'text',
                ...
                array(
                    ...
                    'size' => 60,
                    'required' => false,
                    'desc' => $this->module->l('Enter Your Category Meta Keyword. Separated by comma(,)')
                ),
                array(
                    'type' => 'textarea',
                    ...
                    'lang' => true,
                    'required' => false,
                    'desc' => $this->module->l('Enter Your Category Meta Description')
                ),
                array(
                    'type' => 'text',
                    ...
                    'lang' => true,
                    'required' => true,
                    'desc' => $this->module->l('Enetr Your Category Rewrite. Use In SEO Friendly URL')
                ),
