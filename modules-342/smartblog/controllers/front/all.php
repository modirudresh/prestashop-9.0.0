...
class SmartBlogAllModuleFrontController extends ModuleFrontController
{
    ...
    public function getTemplateVarPage()
    {
		...
		$page['meta']['title'] = Configuration::get('smartblogmetatitle', $id_lang);
    ...
    public function getBreadcrumbLinks()
    {
        ...
        $breadcrumb['links'][] = [
            'title' => Configuration::get('smartblogmetatitle', $id_lang),
    ...
    {   
        ...
        $this->context->smarty->assign(array(
			...
			'header_title' => Configuration::get('smartblogmetatitle', $id_lang),
