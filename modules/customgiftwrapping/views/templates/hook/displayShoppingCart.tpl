...
<div class="customgiftwrapping-form p-4 mb-4 container-fluid">
    ...
    {if $gift_wrap_applied}
        <div class="alert alert-success gift-wrap-status">
            ...
            <div class="gift-wrap-details mb-3">
                <p>{l s='Gift Wrapping Fee:' mod='customgiftwrapping'} {$gift_wrapping_extra_fee|number_format:2:'.':','} {$currency.sign}</p>
            </div>
    ...
    {elseif isset($wrapper_images) && $wrapper_images|@count}
        <div class="gift-wrap-selection">
            ...
            <form method="post" class="gift-wrap-form">
                <div class="customgiftwrapping-options overflow-auto d-flex gap-3">
                    {foreach from=$wrapper_images item=img key=idx}
                        <div class="gift-wrap-option text-center flex-shrink-0" style="width: 60px;">
                            <input type="radio" 
                                   ...
                                   id="giftwrap-{$idx}" 
                                   value="{$img}" 
                                   class="d-none giftwrap-radio" 
                                   required />

                            <label for="giftwrap-{$idx}" class="d-block">
                                <img src="{$img}" 
                ...
                <div class="d-flex justify-content-center mt-3">
                    <button type="submit" name="submitGiftWrapping" class="btn btn-primary">
                        ...
                        <span>{l s='Add Gift Wrapping' mod='customgiftwrapping'} {$gift_wrapping_price|number_format:2:'.':','} {$currency.sign}</span>
                    </button>
                </div>
            </form>
        </div>
