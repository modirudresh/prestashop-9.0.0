...
class ProductComments extends Module implements WidgetInterface
{
    ...
    public function getContainerExtension()
    {
        if (null === $this->extension) {
            require_once __DIR__ . '/src/DependencyInjection/ProductCommentsExtension.php';
            $this->extension = new \PrestaShop\Module\ProductComment\DependencyInjection\ProductCommentsExtension();
        }
