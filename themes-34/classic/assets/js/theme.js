          ...
          (function () {
            ...
            var t,
              ...
              h =
                ...
                (u = (function () {
                  ...
                  return (
                    ...
                    (n.prototype._removeElement = function (e) {
                      return (
                        t(e).removeClass(c),
                        p.supportsTransitionEnd() && t(e).hasClass(l)
                          ? void t(e)
                              .one(
                                p.TRANSITION_END,
                ...
                (t.fn[n] = u._jQueryInterface),
                (t.fn[n].Constructor = u),
                ...
                (function (t) {
                    ...
                    v = (function () {
                      ...
                      return (
                        (n.prototype.toggle = function () {
                          var e = !0,
                            n = t(this._element).closest(f)[0];
                          if (n) {
                            var r = t(this._element).find(p)[0];
                            if (r) {
                              if ("radio" === r.type)
                                if (r.checked && t(this._element).hasClass(a))
                                  e = !1;
                                else {
                                  var i = t(n).find(h)[0];
                                  i && t(i).removeClass(a);
                        ...
                        (n._jQueryInterface = function (e) {
                          return this.each(function () {
                            var i = t(this).data(r);
                            i || ((i = new n(this)), t(this).data(r, i)),
                              "toggle" === e && i[e]();
                          });
                        }),
                        d(n, null, [
                  ...
                  t(document)
                    .on(g.CLICK_DATA_API, u, function (e) {
                      e.preventDefault();
                      var n = e.target;
                      t(n).hasClass(l) || (n = t(n).closest(m)),
                        v._jQueryInterface.call(t(n), "toggle");
                    })
                    .on(g.FOCUS_BLUR_DATA_API, u, function (e) {
                    ...
                    (t.fn[n].noConflict = function () {
                      return (t.fn[n] = s), v._jQueryInterface;
                    });
                })(jQuery),
                (function (t) {
                  var n = "carousel",
                    ...
                    k = (function () {
                      ...
                      return (
                        ...
                        (o.prototype.to = function (e) {
                          var n = this;
                          this._activeElement = t(this._element).find(x)[0];
                        ...
                        (o.prototype._getItemIndex = function (e) {
                          return (
                            (this._items = t.makeArray(t(e).parent().find(S))),
                        ...
                        (o.prototype._slide = function (e, n) {
                          var r = this,
                            i = t(this._element).find(x)[0],
                            o = n || (i && this._getItemByDirection(e, i)),
                            s = Boolean(this._interval),
                            a = e === c ? b : y;
                          if (o && t(o).hasClass(g)) this._isSliding = !1;
                          else if (
                              ...
                              ? (t(o).addClass(e),
                                ...
                                t(i)
                                  .one(p.TRANSITION_END, function () {
                                    t(o).removeClass(a).removeClass(e),
                                      t(o).addClass(g),
                                      t(i)
                                        .removeClass(g)
                                        .removeClass(e)
                        ...
                        (o._dataApiClickHandler = function (e) {
                          ...
                          if (n) {
                            var i = t(n)[0];
                            if (i && t(i).hasClass(m)) {
                              var s = t.extend({}, t(i).data(), t(this).data()),
                                a = this.getAttribute("data-slide-to");
                              a && (s.interval = !1),
                                o._jQueryInterface.call(t(i), s),
                                a && t(i).data(r).to(a),
                                e.preventDefault();
                            }
                          }
                  ...
                  t(document).on(h.CLICK_DATA_API, E, k._dataApiClickHandler),
                    ...
                    (t.fn[n] = k._jQueryInterface),
                    (t.fn[n].Constructor = k),
                    (t.fn[n].noConflict = function () {
                      return (t.fn[n] = s), k._jQueryInterface;
                    });
                })(jQuery),
                (function (t) {
                  var n = "collapse",
                      ...
                      return (
                        ...
                        (i.prototype.show = function () {
                          ...
                          if (
                            ...
                            if (
                              (this._parent &&
                                ((n = t.makeArray(t(y))).length || (n = null)),
                              !(
                                n &&
                                ((o = t(n).data(r)), o && o._isTransitioning)
                              ))
                            ) {
                              ...
                              if (
                                ...
                                n &&
                                  (i._jQueryInterface.call(t(n), "hide"),
                                  o || t(n).data(r, null));
                                ...
                                if (!p.supportsTransitionEnd()) return void f();
                                var d =
                                  "scroll" + (a[0].toUpperCase() + a.slice(1));
                                t(this._element)
                                  .one(p.TRANSITION_END, f)
                                  .emulateTransitionEnd(600),
                        ...
                        (i.prototype._getConfig = function (e) {
                          return (
                            ((e = t.extend({}, s, e)).toggle = Boolean(
                              e.toggle
                            )),
                            p.typeCheckConfig(n, e, a),
                            e
                          );
                        }),
                  ...
                  t(document).on(l.CLICK_DATA_API, b, function (e) {
                    e.preventDefault();
                    var n = w._getTargetFromElement(this),
                      i = t(n).data(r) ? "toggle" : t(this).data();
                    w._jQueryInterface.call(t(n), i);
                  }),
                    (t.fn[n] = w._jQueryInterface),
                    (t.fn[n].Constructor = w),
                    (t.fn[n].noConflict = function () {
                      return (t.fn[n] = o), w._jQueryInterface;
                    });
                })(jQuery),
                (function (t) {
                  var n = "dropdown",
                    ...
                    w = (function () {
                      ...
                      return (
                        (n.prototype.toggle = function () {
                          if (this.disabled || t(this).hasClass(c)) return !1;
                          var e = n._getParentFromElement(this),
                            r = t(e).hasClass(u);
                          if ((n._clearMenus(), r)) return !1;
                          if (
                            "ontouchstart" in document.documentElement &&
                            !t(e).closest(y).length
                          ) {
                            var i = document.createElement("div");
                            (i.className = l),
                              t(i).insertBefore(this),
                              t(i).on("click", n._clearMenus);
                          }
                  ...
                  t(document)
                    ...
                    (t.fn[n].Constructor = w),
                    (t.fn[n].noConflict = function () {
                      return (t.fn[n] = s), w._jQueryInterface;
                    });
                })(jQuery),
                (function (t) {
                  var n = "modal",
                    ...
                    x = (function () {
                      ...
                      return (
                        ...
                        (o.prototype.show = function (e) {
                          var n = this,
                            r = t.Event(l.SHOW, { relatedTarget: e });
                        ...
                        (o.prototype._showBackdrop = function (e) {
                          var n = this,
                            r = t(this._element).hasClass(m) ? m : "";
                          if (this._isShown && this._config.backdrop) {
                            var i = p.supportsTransitionEnd() && r;
                            if (
                        ...
                        (o.prototype._setScrollbar = function () {
                          var e = parseInt(t(w).css("padding-right") || 0, 10);
                        ...
                        (o._jQueryInterface = function (e, n) {
                          return this.each(function () {
                            ...
                            if (
                              (i || ((i = new o(this, s)), t(this).data(r, i)),
                              "string" == typeof e)
                            ) {
                              if (void 0 === i[e])
                                throw new Error('No method named "' + e + '"');
                  ...
                  t(document).on(l.CLICK_DATA_API, y, function (e) {
                    var n = this,
                      i = void 0,
                    ...
                    x._jQueryInterface.call(t(i), s, this);
                  }),
                    (t.fn[n] = x._jQueryInterface),
                    (t.fn[n].Constructor = x),
                    (t.fn[n].noConflict = function () {
                      return (t.fn[n] = o), x._jQueryInterface;
                    });
                })(jQuery),
                (function (t) {
                  var n = "scrollspy",
                    ...
                    _ = (function () {
                      ...
                      return (
                        ...
                        (o.prototype._getConfig = function (e) {
                          if (
                            "string" != typeof (e = t.extend({}, s, e)).target
                          ) {
                            var r = t(e.target).attr("id");
                            r || ((r = p.getUID(n)), t(e.target).attr("id", r)),
                              (e.target = "#" + r);
                          }
                          return p.typeCheckConfig(n, e, a), e;
                        }),
                        ...
                        (o.prototype._clear = function () {
                          t(this._selector).filter(m).removeClass(u);
                        }),
                        (o._jQueryInterface = function (e) {
                          return this.each(function () {
                            var n = t(this).data(r),
                  ...
                  t(window).on(l.LOAD_DATA_API, function () {
                    for (var e = t.makeArray(t(h)), n = e.length; n--; ) {
                      var r = t(e[n]);
                      _._jQueryInterface.call(r, r.data());
                    }
                  }),
                    (t.fn[n] = _._jQueryInterface),
                    (t.fn[n].Constructor = _),
                    (t.fn[n].noConflict = function () {
                      return (t.fn[n] = o), _._jQueryInterface;
                    });
                })(jQuery),
                (function (t) {
                  var n = "tab",
                      ...
                      return (
                        (n.prototype.show = function () {
                          ...
                          if (
                            ...
                            i &&
                              (r = (r = t.makeArray(t(i).find(g)))[
                                r.length - 1
                              ]);
                            var a = t.Event(s.HIDE, {
                                relatedTarget: this._element,
                              }),
                              c = t.Event(s.SHOW, { relatedTarget: r });
                            if (
                              (r && t(r).trigger(a),
                              ...
                              var u = function () {
                                var n = t.Event(s.HIDDEN, {
                                  ...
                                  i = t.Event(s.SHOWN, { relatedTarget: r });
                        ...
                        (n.prototype._activate = function (e, n, r) {
                          ...
                          i && o
                            ? t(i)
                                .one(p.TRANSITION_END, s)
                                .emulateTransitionEnd(150)
                            : s(),
                            i && t(i).removeClass(u);
                        }),
                        (n.prototype._transitionComplete = function (
                          e,
                          n,
                          r,
                          i
                          ...
                          if (
                            ...
                            r
                              ? (p.reflow(e), t(e).addClass(u))
                              : t(e).removeClass(c),
                            e.parentNode && t(e.parentNode).hasClass(a))
                          ) {
                            var s = t(e).closest(f)[0];
                            s && t(s).find(b).addClass(l),
                              e.setAttribute("aria-expanded", !0);
                          }
                          i && i();
                        }),
                  ...
                  t(document).on(s.CLICK_DATA_API, y, function (e) {
                    e.preventDefault(),
                      x._jQueryInterface.call(t(this), "show");
                  }),
                    (t.fn[n] = x._jQueryInterface),
                    (t.fn[n].Constructor = x),
                    (t.fn[n].noConflict = function () {
                ...
                (function (t) {
                      ...
                      return (
                        ...
                        (o.prototype.show = function () {
                          ...
                          if (this.isWithContent() && this._isEnabled) {
                            ...
                            i.setAttribute("id", s),
                              ...
                              this.setContent(),
                              this.config.animation && t(i).addClass(m);
                            var a =
                        ...
                        (o.prototype._setListeners = function () {
                          ...
                          this.config.trigger.split(" ").forEach(function (n) {
                            if ("click" === n)
                              ...
                              t(e.element)
                                .on(r, e.config.selector, t.proxy(e._enter, e))
                                .on(i, e.config.selector, t.proxy(e._leave, e));
                            }
                          }),
                        ...
                        (o.prototype._enter = function (e, n) {
                          ...
                          return (
                            ...
                            e &&
                              (n._activeTrigger["focusin" === e.type ? w : b] =
                                !0),
                        ...
                        (o.prototype._leave = function (e, n) {
                          ...
                          if (
                            ((n = n || t(e.currentTarget).data(r)) ||
                              ...
                              t(e.currentTarget).data(r, n)),
                            e &&
                              (n._activeTrigger["focusout" === e.type ? w : b] =
                                !1),
                  ...
                  return (
                    (t.fn[n] = S._jQueryInterface),
                    (t.fn[n].Constructor = S),
                    (t.fn[n].noConflict = function () {
                      return (t.fn[n] = o), S._jQueryInterface;
                    }),
                    S
                  );
                })(jQuery));
            !(function (t) {
                  ...
                  return (
                    ...
                    (h.prototype.setContent = function () {
                      ...
                      this.setElementContent(e.find(u), this.getTitle()),
                        this.setElementContent(e.find(p), this._getContent()),
                    ...
                    (h._jQueryInterface = function (e) {
                      return this.each(function () {
                        ...
                        if (
                          ...
                          (n || ((n = new h(this, i)), t(this).data(r, n)),
                          "string" == typeof e)
                        ) {
                          if (void 0 === n[e])
                            throw new Error('No method named "' + e + '"');
              ...
              (t.fn[n] = g._jQueryInterface),
                ...
                (t.fn[n].noConflict = function () {
                  return (t.fn[n] = o), g._jQueryInterface;
                });
            })(jQuery);
          })();
      },
              ...
              function (e, t, n) {
                function r(e) {
                  ...
                  if (e instanceof Element) {
                    ...
                    for (var l in (i(t, a), o(t, r), t)) t[l] = c(t, l, e);
                ...
                function s(e, t) {
                  for (var n in e) n in t && !l.test(n) && (e[n] = t[n]);
                }
                t.exports = r;
                var a = /([^\s:;]+)\s*:\s*([^;]+?)\s*(;|$)/g,
      ...
      277: function (e, t, n) {
         ...
         */ (s = function (e) {
          ...
          function n(t, n) {
                  ...
                  return (
                    ...
                    !c || Ce === n.fingers || n.fingers === y || W()
                      ? ((Te = oe()),
                        2 == Ce &&
                          (Z(1, c[1]),
                          (ge = ve = re(Ee[0].start, Ee[1].start))),
                        (n.swipeStatus || n.pinchStatus) && (l = L(a, _e)))
                      : (l = !1),
                    !1 === l
                      ? (L(a, (_e = _)), l)
                      : (n.hold &&
            ...
            function O(t) {
              ...
              if (_e !== S && _e !== _ && !X()) {
                ...
                if (
                  ...
                  2 == Ce &&
                    (0 == ge
                      ? (Z(1, w[1]), (ge = ve = re(Ee[0].start, Ee[1].start)))
                      : (J(w[1]),
                        (ve = re(Ee[0].end, Ee[1].end)),
                        Ee[0].end,
                        Ee[1].end,
                        (we = 1 > ye ? l : a)),
                    (ye = ((ve / ge) * 1).toFixed(2)),
                    (be = Math.abs(ge - ve))),
                  Ce === n.fingers || n.fingers === y || !w || W())
                ) {
                  if (
                    ((pe = ie(C.start, C.end)),
                    (function (e, t) {
                    ...
                    (d = de),
                    (f = pe) != c &&
                      ((d = Math.max(d, ee(f))), (xe[f].distance = d)),
                    (b = L(m, _e)),
                    ...
                    !n.triggerOnTouchEnd && E
                      ? (_e = D(x))
                      : n.triggerOnTouchLeave && !E && (_e = D(S)),
                      (_e != _ && _e != S) || L(m, _e);
                  }
                } else L(m, (_e = _));
                !1 === b && L(m, (_e = _));
            ...
            function N(e) {
              var t = e.originalEvent ? e.originalEvent : e;
              n.triggerOnTouchLeave && L(t, (_e = D(S)));
            }
            function j() {
              Se.off(ae, A),
                Se.off(fe, P),
              ...
              if (u == f) {
                ...
                if (c == S && R()) {
                  if (
                    (clearTimeout(Pe),
                    clearTimeout(Ne),
                    Se.trigger("swipe", [pe, de, me, Ce, Ee, he]),
                    n.swipe &&
                      !1 === (g = n.swipe.call(Se, t, pe, de, me, Ce, Ee, he)))
                  )
                    return !1;
                  switch (pe) {
                    case r:
                      Se.trigger("swipeLeft", [pe, de, me, Ce, Ee, he]),
                        n.swipeLeft &&
                          (g = n.swipeLeft.call(Se, t, pe, de, me, Ce, Ee, he));
                      break;
                    case i:
                      Se.trigger("swipeRight", [pe, de, me, Ce, Ee, he]),
                        n.swipeRight &&
                          (g = n.swipeRight.call(
                            Se,
                            t,
                      ...
                      break;
                    case o:
                      Se.trigger("swipeUp", [pe, de, me, Ce, Ee, he]),
                        n.swipeUp &&
                          (g = n.swipeUp.call(Se, t, pe, de, me, Ce, Ee, he));
                      break;
                    case s:
                      Se.trigger("swipeDown", [pe, de, me, Ce, Ee, he]),
                        n.swipeDown &&
                          (g = n.swipeDown.call(Se, t, pe, de, me, Ce, Ee, he));
                  }
                }
              }
              if (u == d) {
            ...
            n = e.extend({}, n);
            var se = C || T || !n.fallbackToMouseEvents,
              ae = se
                ? T
                  ? E
                    ? "MSPointerDown"
              ...
              ce = se
                ? T
                  ...
                  : "touchend"
                : "mouseup",
              ue = se ? (T ? "mouseleave" : null) : "mouseleave",
              fe = T
                ? E
                  ? "MSPointerCancel"
                  : "pointercancel"
                  ...
                  if (null !== (t = i.text.exec(n))) r.push(t[0]);
                    ...
                    if (t[2]) {
                      ...
                      for (
                        ...
                        if (null !== (c = i.key_access.exec(l))) s.push(c[1]);
                        else {
      ...
      682: function (e, t, n) {
        ...
        function u(e, t, n) {
          n.forEach(function (n) {
            -1 === t.indexOf(n) && e.classList.contains(n) && c(e, n);
          }),
            t.forEach(function (t) {
              e.classList.contains(t) || a(e, t);
            });
        }
        n.r(t);
        var f = [];
        ...
        function w(e, t) {
          var n;
          t === document
            ? ((n = document), (t = document.documentElement))
            : (n = t.ownerDocument);
          ...
          return (
            ...
            (i.right = n.body.clientWidth - i.width - i.left),
            (i.bottom = n.body.clientHeight - i.height - i.top),
            i
          );
        }
        function x(e) {
            ...
            position: function (e) {
              ...
              return (
                ...
                ["left", "top", "right", "bottom"].forEach(function (e) {
                  t.all.push(l("abutted", m, g) + "-" + e);
                }),
                p.length && this.add.push(l("abutted", m, g)),
                p.forEach(function (e) {
                  t.add.push(l("abutted", m, g) + "-" + e);
                }),
                d(function () {
                  !1 !== t.options.addTargetClasses &&
                    u(t.target, t.add, t.all),
                    u(t.element, t.add, t.all);
                }),
                !0
              );
            },
        ...
        var C = {
            position: function (e) {
              ...
              var a = this.cache("element-bounds", function () {
                  return w(t.bodyElement, t.element);
                }),
                c = a.height,
                f = a.width;
              if (0 === f && 0 === c && !s(this.lastSize)) {
                var p = this.lastSize;
              ...
              var h = this.cache("target-bounds", function () {
                ...
                x = y.classPrefix,
                S = (function (e, t, n) {
                  var r = [l("pinned", e, t), l("out-of-bounds", e, t)];
                  return (
                    n.forEach(function (e) {
                      var t = e.outOfBoundsClass,
                        n = e.pinnedClass;
                      t && r.push(t), n && r.push(n);
                    }),
              ...
              return (
                this.options.constraints.forEach(function (e) {
                  ...
                  var y = (function (e, t, n) {
                    ...
                    if (
                      ...
                      n === document && (n = n.documentElement),
                      !s(n.nodeType))
                    ) {
                      var r = n,
                        i = w(e, n),
                      ...
                      if (
                        ...
                        var l = r.ownerDocument.defaultView;
                        (n[0] += l.pageXOffset),
                          (n[1] += l.pageYOffset),
                          (n[2] += l.pageXOffset),
                          (n[3] += l.pageYOffset);
                      ...
                      _.forEach(function (e, t) {
                        ...
                        "Left" === e
                          ? (n[t] += parseFloat(a["border" + e + "Width"]))
                          : (n[t] -= parseFloat(a["border" + e + "Width"]));
                      });
                    }
                    return n;
                  ...
                  (n = (function (e, t, n, r, i, o) {
                    return (
                      ...
                      e + n > t[3] &&
                        (r.indexOf("bottom") >= 0
                          ? ((e = t[3] - n), i.push("bottom"))
                          : o.push("bottom")),
                      e
                    );
                  })(n, y, c, h, k, A)),
                  k.length) &&
                    ((S = s(t.options.pinnedClass)
                      ? l("pinned", b, x)
                  ...
                  !(function (e, t, n, r, i) {
                    var o;
                    e.length &&
                      ((o = s(i) ? l("out-of-bounds", n, r) : i),
                      t.push(o),
                      e.forEach(function (e) {
                        t.push(o + "-" + e);
                      }));
                  })(A, C, b, x, t.options.outOfBoundsClass),
                    ...
                    (E.top === i.top &&
                      E.left === i.left &&
                      T.top === t.attachment.top &&
                      T.left === t.attachment.left) ||
                      (t.updateAttachClasses(T, E),
                      t.trigger("update", {
                        attachment: T,
                        targetAttachment: E,
                      }));
                ...
                d(function () {
                  !1 !== t.options.addTargetClasses && u(t.target, C, S),
                    u(t.element, C, S);
                }),
                { top: n, left: r }
              );
          ...
          E = {
            position: function (e) {
              ...
              if (this.options.shift) {
                var r,
                  i,
                  s = this.options.shift;
                if (
                  ("function" == typeof s &&
                    (s = s.call(this, { top: t, left: n })),
                  o(s))
                ) {
                  (s = s.split(" "))[1] = s[1] || s[0];
                  var a = s;
          ...
          T = (function () {
            ...
            return (
              (t.on = function (e, t, n, r) {
                return (
                  void 0 === r && (r = !1),
                  s(this.bindings) && (this.bindings = {}),
                  s(this.bindings[e]) && (this.bindings[e] = []),
                ...
                return (
                  s(this.bindings) ||
                    ...
                    (s(t)
                      ...
                      : this.bindings[e].forEach(function (r, i) {
                          r.handler === t && n.bindings[e].splice(i, 1);
                        })),
                  this
                );
              }),
              (t.trigger = function (e) {
                ...
                return (
                  !s(this.bindings) &&
                    this.bindings[e] &&
                    this.bindings[e].forEach(function (n, i) {
                      var o = n.ctx,
                        s = n.handler,
                        a = n.once,
                        l = o || t;
                      s.apply(l, r), a && t.bindings[e].splice(i, 1);
                    }),
                  this
                );
              }),
          ...
          k = { center: "center", left: "right", right: "left" },
          A = { middle: "middle", top: "bottom", bottom: "top" },
          O = {
            top: 0,
            left: 0,
            middle: "50%",
        ...
        (F = null),
          ...
          (V = function e() {
            if (!s(B) && B > 16)
              return (B = Math.min(B - 16, 250)), void (M = setTimeout(e, 250));
            (!s(F) && q() - F < 10) ||
        ...
        var $ = (function (e) {
          ...
          function f(t) {
            var n;
            return (
              ((n = e.call(this) || this).position = n.position.bind(i(n))),
              W.push(i(n)),
              (n.history = []),
              n.setOptions(t, !1),
              L.modules.forEach(function (e) {
                s(e.initialize) || e.initialize.call(i(n));
              }),
              n.position(),
              n
            );
          ...
          (n = e),
            ((t = f).prototype = Object.create(n.prototype)),
            (t.prototype.constructor = t),
            r(t, n);
          var h = f.prototype;
          return (
            (h.setOptions = function (e, t) {
              var n = this;
              void 0 === t && (t = !0);
              var r = {
                offset: "0 0",
              ...
              if (
                ...
                ["element", "target"].forEach(function (e) {
                  ...
                  s(n[e].jquery)
                    ? o(n[e]) && (n[e] = document.querySelector(n[e]))
                    : (n[e] = n[e][0]);
                }),
                this._addClasses(),
              ...
              (this.targetAttachment = j(this.options.targetAttachment)),
                ...
                s(this.scrollParents) || this.disable(),
                "scroll-handle" === this.targetModifier
                  ...
                  : (this.scrollParents = (function (e) {
                      ...
                      for (
                        ...
                        if (s(i) || null === i) return n.push(r), n;
                        var o = i,
                          a = o.overflow,
                          l = o.overflowX,
                          c = o.overflowY;
            ...
            (h.getTargetBounds = function () {
              return s(this.targetModifier)
                ? w(this.bodyElement, this.target)
                ...
                ? (function (e, t) {
                    ...
                    return (
                      (r.height = Math.min(
                        r.height,
                        n.height - (pageYOffset - n.top)
                      )),
                      (r.height = Math.min(
                        r.height,
                        n.height -
                          (n.top + n.height - (pageYOffset + innerHeight))
                      )),
                      (r.height = Math.min(innerHeight, r.height)),
                      (r.height -= 2),
                      (r.width = Math.min(
                        r.width,
                        n.width - (pageXOffset - n.left)
                      )),
                      (r.width = Math.min(
                        r.width,
                        n.width -
                          (n.left + n.width - (pageXOffset + innerWidth))
                      )),
                ...
                ? (function (e, t) {
                    ...
                    var a =
                      ...
                      l = {
                        width: 15,
                        height: 0.975 * a * (a / t.scrollHeight),
                        left:
                          n.left + n.width - parseFloat(o.borderLeftWidth) - 15,
                      },
                      c = 0;
                    a < 408 &&
                      i &&
                      (c = -11e-5 * Math.pow(a, 2) - 0.00727 * a + 22.58),
                      i || (l.height = Math.max(l.height, 24));
                    var u = r / (t.scrollHeight - a);
                    return (
                      (l.top =
                        u * (a - l.height - c) +
                        n.top +
            ...
            (h.cache = function (e, t) {
              return (
                s(this._cache) && (this._cache = {}),
                s(this._cache[e]) && (this._cache[e] = t.call(this)),
                this._cache[e]
              );
            }),
            (h.enable = function (e) {
              ...
              !1 !== this.options.addTargetClasses &&
                a(this.target, l("enabled", r, i)),
                a(this.element, l("enabled", r, i)),
                (this.enabled = !0),
            ...
            (h.disable = function () {
              var e = this,
                ...
                n = t.classes,
                r = t.classPrefix;
              c(this.target, l("enabled", n, r)),
                c(this.element, l("enabled", n, r)),
                (this.enabled = !1),
                s(this.scrollParents) ||
            ...
            (h.destroy = function () {
              ...
              this.disable(),
                ...
                0 === W.length &&
                  ((e = this.bodyElement), b && e.removeChild(b), (b = null));
            }),
            (h.updateAttachClasses = function (e, t) {
              var n = this;
              (e = e || this.attachment), (t = t || this.targetAttachment);
              var r = this.options,
                i = r.classes,
                o = r.classPrefix;
              !s(this._addAttachClasses) &&
                this._addAttachClasses.length &&
                this._addAttachClasses.splice(0, this._addAttachClasses.length),
                s(this._addAttachClasses) && (this._addAttachClasses = []),
                (this.add = this._addAttachClasses),
                e.top &&
                  this.add.push(l("element-attached", i, o) + "-" + e.top),
                e.left &&
                  this.add.push(l("element-attached", i, o) + "-" + e.left),
                t.top &&
                  this.add.push(l("target-attached", i, o) + "-" + t.top),
                t.left &&
                  this.add.push(l("target-attached", i, o) + "-" + t.left),
                (this.all = []),
                ["left", "top", "bottom", "right", "middle", "center"].forEach(
                  function (e) {
                    n.all.push(l("element-attached", i, o) + "-" + e),
                      n.all.push(l("target-attached", i, o) + "-" + e);
                  }
                ),
                d(function () {
                  s(n._addAttachClasses) ||
                    (u(n.element, n._addAttachClasses, n.all),
                    !1 !== n.options.addTargetClasses &&
                      u(n.target, n._addAttachClasses, n.all),
            ...
            (h.position = function (e) {
              ...
              if ((void 0 === e && (e = !0), this.enabled)) {
                ...
                var r = this.cache("element-bounds", function () {
                  ...
                  i = r.width,
                  o = r.height;
                if (0 !== i || 0 !== o || s(this.lastSize))
                  this.lastSize = { width: i, height: o };
                else {
                  var a = this.lastSize;
                ...
                var l = this.cache("target-bounds", function () {
                  ...
                  c = l,
                  u = N(P(this.attachment), { width: i, height: o }),
                  f = N(P(n), c),
                  d = N(this.offset, { width: i, height: o }),
                  h = N(this.targetOffset, c);
                (u = I(u, d)), (f = I(f, h));
                for (
                  var m = l.left + f.left - u.left,
                    v = l.top + f.top - u.top,
                    y = 0;
                  y < L.modules.length;
                  ++y
                ) {
                  var b = L.modules[y].position.call(this, {
                    left: m,
                    top: v,
                    targetAttachment: n,
                    targetPos: l,
                  ...
                  if (!1 === b) return !1;
                  s(b) || "object" != typeof b || ((v = b.top), (m = b.left));
                }
                var x,
                  S = {
                    page: { top: v, left: m },
                  ...
                  C = _.defaultView;
                if (
                  (C.innerHeight > _.documentElement.clientHeight &&
                    ((x = this.cache("scrollbar-size", g)),
                    (S.viewport.bottom -= x.height)),
                  C.innerWidth > _.documentElement.clientWidth &&
                    ((x = this.cache("scrollbar-size", g)),
                    (S.viewport.right -= x.width)),
                  (-1 !== ["", "static"].indexOf(_.body.style.position) &&
                    -1 !==
                      ["", "static"].indexOf(
                        _.body.parentElement.style.position
                      )) ||
                    ((S.page.bottom = _.body.scrollHeight - v - o),
                    (S.page.right = _.body.scrollWidth - m - i)),
                  !s(this.options.optimizations) &&
                    !1 !== this.options.optimizations.moveElement &&
                    s(this.targetModifier))
                ) {
                  var E = this.cache("target-offsetparent", function () {
                      return D(t.target);
                    }),
                    T = this.cache("target-offsetparent-bounds", function () {
                      return w(t.bodyElement, E);
                    }),
                  ...
                  if (
                    (["Top", "Left", "Bottom", "Right"].forEach(function (e) {
                      F[e.toLowerCase()] = parseFloat(
                        O["border" + e + "Width"]
                      );
                    }),
                    (T.right = _.body.scrollWidth - T.left - j.width + F.right),
                    (T.bottom =
                      _.body.scrollHeight - T.top - j.height + F.bottom),
                    S.page.top >= T.top + F.top &&
                      S.page.bottom >= T.bottom &&
                      S.page.left >= T.left + F.left &&
                      S.page.right >= T.right)
                  ) {
                    var B = E.scrollLeft,
                      M = E.scrollTop;
                    S.offset = {
                      top: S.page.top - T.top + M - F.top,
                      left: S.page.left - T.left + B - F.left,
                    };
                  }
                }
                return (
            ...
            (h.move = function (e) {
              var t = this;
              if (!s(this.element.parentNode)) {
                var n,
                  r,
                  i,
                  o = {};
                for (var a in e)
                  for (var l in ((o[a] = {}), e[a])) {
                    for (var c = !1, u = 0; u < this.history.length; ++u) {
                      var f = this.history[u];
                      if (
                        !(
                          s(f[a]) ||
                          ((n = f[a][l]),
                ...
                var p = { top: "", left: "", right: "", bottom: "" },
                  h = function (e, n) {
                    var r, i;
                    !1 !==
                    (!s(t.options.optimizations)
                      ? t.options.optimizations.gpu
                      : null)
                      ? (e.top
                          ? ((p.top = 0), (r = n.top))
                          : ((p.bottom = 0), (r = -n.bottom)),
                        e.left
                          ? ((p.left = 0), (i = n.left))
                          : ((p.right = 0), (i = -n.right)),
                        "number" == typeof window.devicePixelRatio &&
                          ...
                          (r =
                            ...
                            devicePixelRatio)),
                        (p[H] =
                          "translateX(" + i + "px) translateY(" + r + "px)"),
                        "msTransform" !== H && (p[H] += " translateZ(0)"))
                      : (e.top
                          ? (p.top = n.top + "px")
                          : (p.bottom = n.bottom + "px"),
                        e.left
                          ? (p.left = n.left + "px")
                          : (p.right = n.right + "px"));
                  },
                ...
                if (
                  ...
                  (p.position = "absolute"), h(o.page, e.page);
                else if (
                  g &&
                  (o.viewport.top || o.viewport.bottom) &&
                  (o.viewport.left || o.viewport.right)
                )
                  (p.position = "fixed"), h(o.viewport, e.viewport);
                else if (!s(o.offset) && o.offset.top && o.offset.left) {
                  p.position = "absolute";
                  var w = this.cache("target-offsetparent", function () {
                    return D(t.target);
                  });
                  D(this.element) !== w &&
                    d(function () {
                      t.element.parentNode.removeChild(t.element),
                        w.appendChild(t.element);
                    }),
                    h(o.offset, e.offset),
                    (b = !0);
                } else
                  (p.position = "absolute"), h({ top: !0, left: !0 }, e.page);
                if (!b)
                  if (this.options.bodyElement)
                    ...
                    for (
                      var x = !0, S = this.element.parentNode;
                      S &&
                      1 === S.nodeType &&
                      "BODY" !== S.tagName &&
                      ((y = void 0),
                      ((y = (v = S).ownerDocument).fullscreenElement ||
                        y.webkitFullscreenElement ||
                        y.mozFullScreenElement ||
                        y.msFullscreenElement) !== v);
                ...
                for (var E in p) {
                  var T = p[E];
                  this.element.style[E] !== T && ((C = !0), (_[E] = T));
                }
                C &&
                  d(function () {
                    m(t.element.style, _), t.trigger("repositioned");
                  });
              }
            }),
            (h._addClasses = function () {
              var e = this.options,
                t = e.classes,
                n = e.classPrefix;
              a(this.element, l("element", t, n)),
                !1 !== this.options.addTargetClasses &&
                  a(this.target, l("target", t, n));
            }),
            (h._removeClasses = function () {
              var e = this,
                t = this.options,
                n = t.classes,
                r = t.classPrefix;
              c(this.element, l("element", n, r)),
                !1 !== this.options.addTargetClasses &&
                  c(this.target, l("target", n, r)),
                this.all.forEach(function (t) {
                  e.element.classList.remove(t), e.target.classList.remove(t);
                });
            }),
            f
          );
        })(T);
        ($.modules = []), (L.position = R);
        var z = m($, L);
        z.modules.push({
          initialize: function () {
            var e = this,
              ...
              r = t.classPrefix;
            (this.markers = {}),
              ["target", "element"].forEach(function (t) {
                var i = document.createElement("div");
                i.className = l(t + "-marker", n, r);
                var o = document.createElement("div");
                (o.className = l("marker-dot", n, r)),
                  i.appendChild(o),
                  e[t].appendChild(i),
                  (e.markers[t] = { dot: o, el: i });
              });
          },
          position: function (e) {
            var t = { element: e.manualOffset, target: e.manualTargetOffset };
            for (var n in t) {
              var r = t[n];
              for (var i in r) {
                var s,
                ...
                (!o(a) || (-1 === a.indexOf("%") && -1 === a.indexOf("px"))) &&
                  (a += "px"),
                  this.markers[n] &&
                    (null == (s = this.markers[n].dot)
                      ? void 0
                      : s.style[i]) !== a &&
                    (this.markers[n].dot.style[i] = a);
              }
            }
            return !0;
          },
          ...
          (function (o) {
            ...
            return (function (e, t, n, r) {
              ...
              if (!(o <= 7)) {
                ...
                var v = (m.CSS = {
                  ...
                  Hooks: {
                    ...
                    register: function () {
                      for (var e = 0; e < v.Lists.colors.length; e++) {
                        var t =
                          "color" === v.Lists.colors[e]
                            ? "0 0 0 1"
                            : "255 255 255 1";
                        v.Hooks.templates[v.Lists.colors[e]] = [
                    ...
                    cleanRootPropertyValue: function (e, t) {
                      return (
                        v.RegEx.valueUnwrap.test(t) &&
                          (t = t.match(v.RegEx.valueUnwrap)[1]),
                        v.Values.isCSSNullValue(t) &&
                          (t = v.Hooks.templates[e][1]),
                        t
                      );
                    },
                    extractValue: function (e, t) {
                      ...
                      if (n) {
                        var r = n[0],
                          i = n[1];
                        return (t = v.Hooks.cleanRootPropertyValue(r, t))
                          .toString()
                          .match(v.RegEx.valueSplit)[i];
                      }
                      return t;
                    },
                    injectValue: function (e, t, n) {
                      ...
                      if (r) {
                        var i,
                          ...
                          s = r[1];
                        return (
                          ((i = (n = v.Hooks.cleanRootPropertyValue(o, n))
                            .toString()
                            .match(v.RegEx.valueSplit))[s] = t),
                          i.join(" ")
                        );
                      }
                      return n;
                  ...
                  Normalizations: {
                          ...
                          case "extract":
                            ...
                            return (r =
                              v.RegEx.wrappedValueAlreadyExtracted.test(n)
                                ? n
                                : (r = n.toString().match(v.RegEx.valueUnwrap))
                                ? r[1].replace(/,(\s+)?/g, " ")
                                : n);
                          case "inject":
                            return "rect(" + n + ")";
                    ...
                    register: function () {
                        ...
                        !(function () {
                          ...
                          v.Normalizations.registered[t] = function (e, n, i) {
                            switch (e) {
                              ...
                              case "extract":
                                return x(n) === r ||
                                  x(n).transformCache[t] === r
                                  ? /^scale/i.test(t)
                                    ? 1
                                    : 0
                                  : x(n).transformCache[t].replace(/[()]/g, "");
                              case "inject":
                                var o = !1;
                                ...
                                return (
                                  o || (x(n).transformCache[t] = "(" + i + ")"),
                                  x(n).transformCache[t]
                                );
                            }
                          };
                        })();
                          ...
                          v.Normalizations.registered[e] = function (t, n, i) {
                            switch (t) {
                              ...
                              case "extract":
                                var s;
                                if (
                                  v.RegEx.wrappedValueAlreadyExtracted.test(i)
                                )
                                  s = i;
                                else {
                                  var a,
                                  ...
                                  /^[A-z]+$/i.test(i)
                                    ? (a = l[i] !== r ? l[i] : l.black)
                                    : v.RegEx.isHex.test(i)
                                    ? (a =
                                        "rgb(" +
                                        v.Values.hexToRgb(i).join(" ") +
                                        ")")
                      ...
                      function n(e, t, n) {
                        if (
                          ...
                          for (r = 0; r < a.length; r++)
                            (i = parseFloat(v.getPropertyValue(t, a[r]))),
                              isNaN(i) || (o += i);
                          return n ? -o : o;
                        }
                        return 0;
                      ...
                      (v.Normalizations.registered.innerWidth = i("width", !0)),
                        (v.Normalizations.registered.innerHeight = i(
                          "height",
                          !0
                        )),
                  ...
                  Names: {
                    ...
                    SVGAttribute: function (e) {
                      ...
                      return (
                        (o || (m.State.isAndroid && !m.State.isChrome)) &&
                          (t += "|transform"),
                    ...
                    prefixCheck: function (e) {
                      ...
                      for (
                        ...
                        if (
                          ...
                          d.isString(m.State.prefixElement.style[i]))
                        )
                  ...
                  getPropertyValue: function (e, n, i, s) {
                        ...
                        if (!s) {
                          if (
                            ...
                            var d =
                              e.offsetHeight -
                              (parseFloat(
                                v.getPropertyValue(e, "borderTopWidth")
                              ) || 0) -
                              (parseFloat(
                                v.getPropertyValue(e, "borderBottomWidth")
                              ) || 0) -
                              (parseFloat(
                                v.getPropertyValue(e, "paddingTop")
                              ) || 0) -
                              (parseFloat(
                                v.getPropertyValue(e, "paddingBottom")
                              ) || 0);
                            return u(), d;
                          }
                          if (
                            ...
                            var p =
                              e.offsetWidth -
                              (parseFloat(
                                v.getPropertyValue(e, "borderLeftWidth")
                              ) || 0) -
                              (parseFloat(
                                v.getPropertyValue(e, "borderRightWidth")
                              ) || 0) -
                              (parseFloat(
                                v.getPropertyValue(e, "paddingLeft")
                              ) || 0) -
                              (parseFloat(
                                v.getPropertyValue(e, "paddingRight")
                              ) || 0);
                            return u(), p;
                          }
                        }
                    ...
                    if (v.Hooks.registered[n]) {
                      var c = n,
                        u = v.Hooks.getRoot(c);
                      i === r &&
                        (i = v.getPropertyValue(e, v.Names.prefixCheck(u)[0])),
                        v.Normalizations.registered[u] &&
                          (i = v.Normalizations.registered[u]("extract", e, i)),
                        (l = v.Hooks.extractValue(c, i));
                    } else if (v.Normalizations.registered[n]) {
                      var d, p;
                      "transform" !==
                        (d = v.Normalizations.registered[n]("name", e)) &&
                        ((p = a(e, v.Names.prefixCheck(d)[0])),
                        v.Values.isCSSNullValue(p) &&
                          v.Hooks.templates[n] &&
                          (p = v.Hooks.templates[n][1])),
                        (l = v.Normalizations.registered[n]("extract", e, p));
                    }
                    if (!/^[\d-]/.test(l)) {
                      var h = x(e);
                      ...
                      else l = a(e, v.Names.prefixCheck(n)[0]);
                    }
                    return (
                      v.Values.isCSSNullValue(l) && (l = 0),
                      m.debug >= 2 && console.log("Get " + n + ": " + l),
                      l
                    );
                  },
                  setPropertyValue: function (e, n, r, i, s) {
                    ...
                    if ("scroll" === n)
                      ...
                      "transform" === v.Normalizations.registered[n]("name", e)
                    )
                      v.Normalizations.registered[n]("inject", e, r),
                        (a = "transform"),
                      ...
                      if (v.Hooks.registered[n]) {
                        var l = n,
                          c = v.Hooks.getRoot(n);
                        (i = i || v.getPropertyValue(e, c)),
                          (r = v.Hooks.injectValue(l, r, i)),
                          (n = c);
                      }
                      if (
                        (v.Normalizations.registered[n] &&
                          ((r = v.Normalizations.registered[n]("inject", e, r)),
                          (n = v.Normalizations.registered[n]("name", e))),
                        ...
                        var u = x(e);
                        u && u.isSVG && v.Names.SVGAttribute(n)
                          ? e.setAttribute(n, r)
                          : (e.style[a] = r);
                      }
                      m.debug >= 2 &&
                  ...
                  (m.hook = function (e, t, n) {
                    ...
                    return (
                      ...
                      f.each(e, function (e, o) {
                        if ((x(o) === r && m.init(o), n === r))
                          i === r && (i = v.getPropertyValue(o, t));
                        else {
                          var s = v.setPropertyValue(o, t, n);
                          "transform" === s[0] && m.CSS.flushTransformCache(o),
                            (i = s);
                        }
                      }),
                      i
                ...
                var y = function () {
                  ...
                  if (
                    (o &&
                      m.Promise &&
                      (b.promise = new m.Promise(function (e, t) {
                        (b.resolver = e), (b.rejecter = t);
                      })),
                    g
                      ? ((p = arguments[0].properties || arguments[0].p),
                        (h = arguments[0].options || arguments[0].o))
                      : ((p = arguments[a]), (h = arguments[a + 1])),
                    (l = u(l)))
                  ) {
                    var w,
                      C = l.length,
                    ...
                    if (
                      ...
                      h = {};
                      for (var O = a + 1; O < arguments.length; O++)
                        d.isArray(arguments[O]) ||
                        (!/^(fast|normal|slow)$/i.test(arguments[O]) &&
                          !/^\d/.test(arguments[O]))
                          ? d.isString(arguments[O]) || d.isArray(arguments[O])
                            ? (h.easing = arguments[O])
                            : d.isFunction(arguments[O]) &&
                              (h.complete = arguments[O])
                          : (h.duration = arguments[O]);
                    }
                    switch (p) {
                      case "scroll":
                        w = "scroll";
                      ...
                      default:
                        if (!f.isPlainObject(p) || d.isEmptyObject(p)) {
                            ...
                            return (
                              ...
                              f.each(l, function (t, n) {
                                parseFloat(e.stagger)
                                  ? (e.delay = j + parseFloat(e.stagger) * t)
                                  : d.isFunction(e.stagger) &&
                                    (e.delay = j + e.stagger.call(n, t, C)),
                                  e.drag &&
                                    ((e.duration =
                                      parseFloat(N) ||
                          ...
                          return (
                            b.promise
                              ? b.rejecter(new Error(D))
                              : t.console && console.log(D),
                            i()
                          );
                        }
                        w = "start";
                    ...
                    f.each(l, function (e, i) {
                          ...
                          function u(u) {
                            ...
                            if ("scroll" === w) {
                              var P,
                                N,
                                j,
                                D = /^x$/i.test(s.axis) ? "Left" : "Top",
                                B = parseFloat(s.offset) || 0;
                              s.container
                                ? d.isWrapped(s.container) ||
                                  d.isNode(s.container)
                                  ? ((s.container =
                                      s.container[0] || s.container),
                                    (j =
                                      (P = s.container["scroll" + D]) +
                                      f(e).position()[D.toLowerCase()] +
                                      B))
                                  : (s.container = null)
                                : ((P =
                                    m.State.scrollAnchor[
                                      m.State["scrollProperty" + D]
                                    ]),
                                  (N =
                                    m.State.scrollAnchor[
                                      m.State[
                              ...
                              for (var M in ("none" === g.opts.display &&
                                (g.opts.display = "auto"),
                              "hidden" === g.opts.visibility &&
                                (g.opts.visibility = "visible"),
                              (g.opts.loop = !1),
                              (g.opts.begin = null),
                              (g.opts.complete = null),
                              h.easing || delete s.easing,
                              h.duration || delete s.duration,
                              (s = f.extend({}, g.opts, s)),
                              (y = f.extend(
                                !0,
                                {},
                                g ? g.tweensContainer : null
                              ))))
                                if (y.hasOwnProperty(M) && "element" !== M) {
                                  var V = y[M].startValue;
                                  (y[M].startValue = y[M].currentValue =
                                    y[M].endValue),
                                    (y[M].endValue = V),
                                    d.isEmptyObject(h) ||
                                      (y[M].easing = s.easing),
                              ...
                              var H = function (i, l) {
                                ...
                                if (
                                  (g && g.isSVG) ||
                                  "tween" === u ||
                                  !1 !== v.Names.prefixCheck(u)[1] ||
                                  v.Normalizations.registered[u] !== r
                                ) {
                                  ((s.display !== r &&
                                    null !== s.display &&
                                    "none" !== s.display) ||
                                    ...
                                    0 !== h &&
                                    (w = 0),
                                    s._cacheValues && y && y[i]
                                      ? (w === r &&
                                          (w = y[i].endValue + y[i].unitType),
                                        (p = g.rootPropertyValueCache[u]))
                                      : v.Hooks.registered[i]
                                      ? w === r
                                        ? ((p = v.getPropertyValue(e, u)),
                                          (w = v.getPropertyValue(e, i, p)))
                                        : (p = v.Hooks.templates[u][1])
                                      : w === r &&
                                        (w = v.getPropertyValue(e, i));
                                  var x,
                                    S,
                                    _,
                                    C = !1,
                                  ...
                                  if (
                                    ...
                                    for (
                                      w = v.Hooks.fixColors(w),
                                        h = v.Hooks.fixColors(h);
                                      T < w.length && k < h.length;
                                      ...
                                      if (
                                        ...
                                        var H = v.Hooks.getUnit(w, T),
                                          W = v.Hooks.getUnit(h, k);
                                        if (
                                          ((T += H.length),
                                          (k += W.length),
                                          H === W)
                                ...
                                if (p.hasOwnProperty(W)) {
                                  var R = v.Names.camelCase(W),
                                    q =
                                      ...
                                      (O = void 0),
                                      (I = void 0),
                                      d.isFunction(S) && (S = S.call(e, i, C)),
                                      d.isArray(S)
                                        ? ((A = S[0]),
                                          (!d.isArray(S[1]) &&
                                            /^[\d-]/.test(S[1])) ||
                                          d.isFunction(S[1]) ||
                                          v.RegEx.isHex.test(S[1])
                                            ? (I = S[1])
                                            : (d.isString(S[1]) &&
                                                !v.RegEx.isHex.test(S[1]) &&
                                                m.Easings[S[1]]) ||
                                        ...
                                        : (A = S),
                                      _ || (O = O || s.easing),
                                      d.isFunction(A) && (A = A.call(e, i, C)),
                                      d.isFunction(I) && (I = I.call(e, i, C)),
                                      [A || 0, O, I]);
                                  if (c(v.Lists.colors)) {
                                    var $ = q[0],
                                      z = q[1],
                          ...
                          if (
                            (!1 !== m.mock &&
                              (!0 === m.mock
                                ...
                                : ((s.duration *= parseFloat(m.mock) || 1),
                                  (s.delay *= parseFloat(m.mock) || 1))),
                            (s.easing = T(s.easing, s.duration)),
                            s.begin &&
                              !d.isFunction(s.begin) &&
                              (s.begin = null),
                            s.progress &&
                              !d.isFunction(s.progress) &&
                              (s.progress = null),
                            s.complete &&
                              !d.isFunction(s.complete) &&
                              (s.complete = null),
                            s.display !== r &&
                              null !== s.display &&
                              ((s.display = s.display.toString().toLowerCase()),
                              "auto" === s.display &&
                                (s.display = m.CSS.Values.getDisplayType(e))),
                            s.visibility !== r &&
                              null !== s.visibility &&
                            ...
                            if (s.delay) {
                              var g = m.State.delayedElements.count++;
                              m.State.delayedElements[g] = e;
                              var y = (function (e) {
                                return function () {
                                  (m.State.delayedElements[e] = !1), u();
                                };
                              })(g);
                              (x(e).delayBegin = new Date().getTime()),
                                (x(e).delay = parseFloat(s.delay)),
                      ...
                      ((e = f.extend({}, m.defaults, h)).loop = parseInt(
                        e.loop,
                        10
                      ));
                    var B = 2 * e.loop - 1;
                  ...
                  b.promise &&
                    (p && h && !1 === h.promiseRejectEmpty
                      ? b.resolver()
                      : b.rejecter());
                };
                (m = f.extend(y, m)).animate = y;
                ...
                return (
                  ...
                  f.each(["Down", "Up"], function (e, t) {
                    m.Redirects["slide" + t] = function (e, n, i, o, s, a) {
                      var l = f.extend({}, n),
                        c = l.begin,
                        u = l.complete,
                        d = {},
                  ...
                  f.each(["In", "Out"], function (e, t) {
                    m.Redirects["fade" + t] = function (e, n, i, o, s, a) {
                      var l = f.extend({}, n),
                        c = l.complete,
                        u = { opacity: "In" === t ? 1 : 0 };
                      0 !== i && (l.begin = null),
              ...
              function E(e, n, r, i) {
                ...
                function d(e, t, n) {
                  return ((c(t, n) * e + u(t, n)) * e + f(t)) * e;
                }
                function p(e, t, n) {
                  return 3 * c(t, n) * e * e + 2 * u(t, n) * e + f(t);
                }
                function h(t) {
                ...
                function g() {
                  (m = !0),
                    (e === n && r === i) ||
                      (function () {
                        for (var t = 0; t < 11; ++t) l[t] = d(t * o, e, r);
                      })();
                }
                var v = function (t) {
                  return (
                  ...
                  d.isString(e)
                    ...
                    : (n =
                        d.isArray(e) && 1 === e.length
                          ...
                          ? g.apply(null, e.concat([t]))
                          : !(!d.isArray(e) || 4 !== e.length) &&
                            E.apply(null, e)),
                  !1 === n &&
                    (n = m.Easings[m.defaults.easing] ? m.defaults.easing : h),
                  n
                );
              }
              function k(e) {
                  ...
                  for (var i = 0; i < n; i++)
                    if (m.State.calls[i]) {
                      var s = m.State.calls[i],
                        ...
                        g = s[5],
                        y = s[6];
                      if ((u || (u = m.State.calls[i][3] = t - 16), g)) {
                        if (!0 !== g.resume) continue;
                        (u = s[3] = Math.round(t - y - 16)), (s[5] = null);
                      }
                      y = s[6] = t - u;
                      for (
                        var w = Math.min(y / c.duration, 1),
                          S = 0,
                          _ = l.length;
                        S < _;
                        S++
                        ...
                        if (x(E)) {
                          ...
                          if (
                            ...
                            if ("flex" === c.display) {
                              f.each(
                                ...
                                function (e, t) {
                                  v.setPropertyValue(E, "display", t);
                                }
                              );
                            }
                            v.setPropertyValue(E, "display", c.display);
                          }
                          for (var O in (c.visibility !== r &&
                            "hidden" !== c.visibility &&
                          ...
                          C))
                            if (C.hasOwnProperty(O) && "element" !== O) {
                              ...
                              } else if (1 === w) I = P.endValue;
                              else {
                                var D = P.endValue - P.startValue;
                                I = P.startValue + D * N(w, c, D);
                              }
                              ...
                              if (((P.currentValue = I), "tween" === O)) h = I;
                                ...
                                if (v.Hooks.registered[O]) {
                                  L = v.Hooks.getRoot(O);
                                  var F = x(E).rootPropertyValueCache[L];
                                  F && (P.rootPropertyValue = F);
                                }
                                var B = v.setPropertyValue(
                                  E,
                                  O,
                                  P.currentValue +
                                    (o < 9 && 0 === parseFloat(I)
                                ...
                                v.Hooks.registered[O] &&
                                  (v.Normalizations.registered[L]
                                    ? (x(E).rootPropertyValueCache[L] =
                                        v.Normalizations.registered[L](
                                          "extract",
                                          null,
                                          B[1]
                                        ))
                                    : (x(E).rootPropertyValueCache[L] = B[1])),
                                  "transform" === B[0] && (T = !0);
                              }
                            }
                          c.mobileHA &&
                            x(E).transformCache.translate3d === r &&
                            ((x(E).transformCache.translate3d =
                              "(0px, 0px, 0px)"),
                            (T = !0)),
                            T && v.flushTransformCache(E);
                        }
                      }
                      c.display !== r &&
                        "none" !== c.display &&
                        ...
                        c.visibility !== r &&
                          "hidden" !== c.visibility &&
                          (m.State.calls[i][2].visibility = !1),
                        c.progress &&
                          c.progress.call(
                            s[1],
                            s[1],
                ...
                m.State.isTicking && b(k);
              }
              function A(e, t) {
                if (!m.State.calls[e]) return !1;
                for (
                  var n = m.State.calls[e][0],
                    i = m.State.calls[e][1],
                    o = m.State.calls[e][2],
                    s = m.State.calls[e][4],
                    a = !1,
                  ...
                  t ||
                    o.loop ||
                    ("none" === o.display &&
                      v.setPropertyValue(u, "display", o.display),
                    "hidden" === o.visibility &&
                      v.setPropertyValue(u, "visibility", o.visibility));
                  var d = x(u);
                  if (
                    !0 !== o.loop &&
                    (f.queue(u)[1] === r ||
                  ...
                  s && !0 !== o.loop && s(i),
                    d &&
                      ...
                      m(u, "reverse", { loop: !0, delay: o.delay })),
                    !1 !== o.queue && f.dequeue(u, o.queue);
                }
                m.State.calls[e] = !1;
                for (var h = 0, g = m.State.calls.length; h < g; h++)
